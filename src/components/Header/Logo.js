...
const Logo = () => {
  return <Link href="/about" className="flex items-center text-dark dark:text-light">
      ...
      <span className="font-bold dark:font-semibold text-lg md:text-xl">Cool Blog</span>
    </Link>;
};
